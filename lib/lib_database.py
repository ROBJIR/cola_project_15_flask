...
class Database ():
    ...
    def dbadm_database_info_show(self):
        ...
        return {"version":f"{self.info_database_version}","database":f"{self.info_current_database}","schema":f"{self.info_current_schema}","pid":f"{self.info_session_id}","user":f"{self.info_current_user}"}
